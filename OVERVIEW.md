...
| 9 | **PostGIS geometry, containers, hosting** | Runs are in Postgres as `jsonb`; *geometry* is not, and nothing yet needs a spatial index. Deploy is Stage 6 |
